"""Unified scoring step for the theoretical-narrative review pipeline.
...
def main() -> None:
    ...
    if originality:
        ...
        print(f"  originality: score={orig_score['score']}  ({orig_score['compared_works']} compared works)", file=stderr)
    else:
